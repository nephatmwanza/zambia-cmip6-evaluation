...
This module is the single source of truth for the statistics used by both analyses -
rainfall (notebooks/05) and temperature (notebooks/07) - so the two cannot drift apart.
